...
import * as Page from './wikidot/interface.page';
      ...
      if (activeEditor?.document.languageId == "ftml") {
        ...
        vscode.authentication.getSession('wikidot', [], {
          ...
          vscode.window.withProgress({
            ...
            try {
              let fetched = fetchedData ?? await Page.getMetadata({
                wikiSite: data.site,
                wikiPage: data.page,
              ...
              if (data.revision === undefined || fetched.revision === undefined || fetched.revision !== undefined && (data.revision < fetched.revision)) {
                ...
                switch (answer) {
                  ...
                  case "Overwrite content":
                    ...
                    let source = await Page.getSource({ wikiSite: data.site, session: sess.accessToken }, data.page);
      ...
      if (activeEditor?.document.languageId == "ftml") {
        ...
        vscode.authentication.getSession('wikidot', [], {
          ...
          vscode.window.withProgress({
            ...
            try {
              let fetched = await Page.getMetadata({
                wikiSite: data.site,
                wikiPage: data.page,
                session: sess.accessToken,
                checkExist: true
