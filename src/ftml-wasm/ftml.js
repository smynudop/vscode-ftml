...
const HtmlOutputFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_htmloutput_free(ptr >>> 0, 1),
			);

const PageInfoFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) => wasm.__wbg_pageinfo_free(ptr >>> 0, 1));

const ParseOutcomeFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_parseoutcome_free(ptr >>> 0, 1),
			);

const SyntaxTreeFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_syntaxtree_free(ptr >>> 0, 1),
			);

const TokenizationFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_tokenization_free(ptr >>> 0, 1),
			);

const Utf16IndexMapFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_utf16indexmap_free(ptr >>> 0, 1),
			);

const WikitextSettingsFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wikitextsettings_free(ptr >>> 0, 1),
			);
...
if (Symbol.dispose)
	HtmlOutput.prototype[Symbol.dispose] = HtmlOutput.prototype.free;
...
if (Symbol.dispose)
	PageInfo.prototype[Symbol.dispose] = PageInfo.prototype.free;
...
if (Symbol.dispose)
	ParseOutcome.prototype[Symbol.dispose] = ParseOutcome.prototype.free;
...
if (Symbol.dispose)
	SyntaxTree.prototype[Symbol.dispose] = SyntaxTree.prototype.free;
...
if (Symbol.dispose)
	Tokenization.prototype[Symbol.dispose] = Tokenization.prototype.free;
...
if (Symbol.dispose)
	Utf16IndexMap.prototype[Symbol.dispose] = Utf16IndexMap.prototype.free;
...
if (Symbol.dispose)
	WikitextSettings.prototype[Symbol.dispose] = WikitextSettings.prototype.free;
...
async function __wbg_init(module_or_path) {
	...
	if (typeof module_or_path === "undefined") {
		throw new Error(
			"You must provide a module or path to initialize the WebAssembly module",
		);
